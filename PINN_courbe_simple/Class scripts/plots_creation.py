...
# Graphs ------------------------------------------------------------
cs = np.load('path/MODELS/2023_11_22_16_11_12_cs.npy')
cg = np.load('path/MODELS/2023_11_22_16_11_12_cg.npy')

cs_analytical = pd.read_csv('path/cs_analytical.csv', header=None)
cg_analytical = pd.read_csv('path/cg_analytical.csv', header=None)
