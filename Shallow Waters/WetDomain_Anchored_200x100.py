...
iterations = 100 #iterations for optimal neural net
...
np.save('C:/diskD/0 - POLYTECH/5A/COURS/PROJET INGE/Projet_ingenieur/h.npy', h)
np.save('C:/diskD/0 - POLYTECH/5A/COURS/PROJET INGE/Projet_ingenieur/u.npy', u)
...
h = np.load('C:/diskD/0 - POLYTECH/5A/COURS/PROJET INGE/Projet_ingenieur/h.npy')
u = np.load('C:/diskD/0 - POLYTECH/5A/COURS/PROJET INGE/Projet_ingenieur/u.npy')

h_analytical = pd.read_csv('C:/diskD/0 - POLYTECH/5A/COURS/PROJET INGE/Projet_ingenieur/h_analytical.csv', header=None)
u_analytical = pd.read_csv('C:/diskD/0 - POLYTECH/5A/COURS/PROJET INGE/Projet_ingenieur/u_analytical.csv', header=None)
